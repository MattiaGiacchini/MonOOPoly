...
public class TileDeckImpl extends AbstractTileDecorator implements TileDeck {
	...
	public static class Builder{
        ...
        public Builder tableSize(Integer tableSize){
            ...
            if(tableSize <= TileDeckImpl.ZERO) {
                throw new IllegalArgumentException(
        ...
        public Builder supplierNumOfPropertyOnTheTable(
               Supplier<Map<Integer, Integer>> supplierMapOfPositionBuildings) {
        ...
        public Builder retriverNumberHotelOfPlayer
                             (Function<Integer, Integer> funNumOfHotelOwnedBy) {
        ...
        public Builder retriverNumberHouseOfPlayer(
                              Function<Integer, Integer> funNumOfHouseOwnedBy) {
        ...
        public Builder retriverSetOfPositionforSpecificCategory(
                Function<Category, Set<Integer>> funPosOfCategoryOnTable) {
	...
	private Card decoreWithMoneyEffect(final Card card) {
		return new MoneyEffect.Builder()
							  ...
							  .makeTheAvaragePlayersBalance(
							          this.deck
							              .getMakeTheAveragePlayersBalance())
							  .build();
	}
